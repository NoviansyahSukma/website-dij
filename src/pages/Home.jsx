  ...
  return (
    <>
      <div className="xl:grid xl:grid-cols-2 xl:gap-4">
        <div
          className={`w-full order-2 h-40 md:h-80 lg:h-96 xl:h-68 2xl:h-93 overflow-hidden shadow-md transition-all transform duration-1500 ease-in-out ${
        ...
        >
          <img
            src={Jumbotron}
            alt="jumbotron-dij"
            className="h-76 md:h-140 lg:h-180 xl:h-140 2xl:h-192 object-cover m-auto -mt-12 md:-mt-18 lg:-mt-28 xl:-mt-24 2xl:-mt-34"
          />
        </div>
        ...
        >
          ...
          <hr className="max-w-64 lg:max-w-80 xl:max-w-64 m-auto my-2 md:mt-3 lg:mt-4 xl:ml-0 xl:mt-1 bg-slate-600" />
      ...
      <div
        className={`text-purple-900 text-center w-full xl:w-4/5 2xl:w-3/5 m-auto tracking-wide grid grid-cols-1 md:grid-cols-3 gap-y-3 mt-5 md:mt-7 lg:mt-10 xl:mt-5 md:px-3 transition-all duration-1500 ease-in-out ${
