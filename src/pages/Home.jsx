  ...
  return (
    <>
      <div className="xl:grid xl:grid-cols-2 xl:gap-4 px-2 xl:px-0 mt-12 md:mt-18 lg:mt-22 xl:mt-2">
        ...
        <div
          className={`order-1 font-roboto text-center xl:text-left text-purple-900 mt-3 md:mt-7 xl:mt-3 2xl:mt-14 xl:px-5 2xl:px-14 transition-all transform duration-1000 ease-in-out ${
            show ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-50"
          }`}
        >
