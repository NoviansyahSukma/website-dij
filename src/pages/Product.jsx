    ...
    <>
      <div className="w-full mt-16 md:mt-24 lg:mt-28 xl:mt-1 grid grid-cols-1 gap-y-10 md:gap-y-14 lg:gap-y-18 xl:gap-y-8 pb-5 2xl:pb-1">
        <div className="w-full m-auto px-3 md:px-5 grid grid-cols-1 xl:grid-cols-2 gap-y-3 md:gap-y-4 lg:gap-y-5 xl:gap-y-0">
          <div
            className={`font-roboto text-center xl:text-left xl:mt-7 2xl:mt-14 xl:px-8 text-purple-900 transition-all transform duration-1500 ease-in-out ${
          ...
          <div
            className={`w-[95%] xl:w-[80%] 2xl:w-[100%] 2xl:h-80 m-auto bg-amber-100 overflow-hidden shadow-md transition-all transform duration-1500 ease-in-out ${
              show ? "opacity-100 translate-x-0" : "opacity-0 translate-x-100"
            }`}
          >
            <img
        ...
        <hr
          className={`w-24 md:w-80 xl:w-96 m-auto bg-slate-100 transition-all transform duration-1500 ease-in-out ${
        ...
        <div className="w-full m-auto px-3 md:px-5 grid grid-cols-1 xl:grid-cols-2 gap-y-3 md:gap-y-4 lg:gap-y-5 xl:gap-y-0">
          <div
            className={`xl:order-2 font-roboto text-center xl:text-right xl:mt-6 2xl:mt-14 xl:px-8 text-purple-900 transition-all transform duration-1500 ease-in-out ${
              show ? "opacity-100 translate-x-0" : "opacity-0 translate-x-100"
            }`}
          >
            <h1 className="tracking-wide text-xl md:text-2xl lg:text-3xl font-bold">
          ...
          <div
            className={`xl:order-1 w-[95%] xl:w-[80%] 2xl:w-[95%] 2xl:h-80 m-auto overflow-hidden shadow-md transition-all transform duration-1500 ease-in-out ${
              show ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-100"
            }`}
          >
            <img
