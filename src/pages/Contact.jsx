...
export default function Contact() {
  ...
  return (
    <>
      <div
        className={`w-full md:w-5/6 xl:w-4/5 2xl:w-3/4 mx-auto md:mt-34 xl:mt-8 px-3 py-4 md:py-6 lg:py-8 transition-[opacity, transform] duration-2000 ease-in-out ${
          show
